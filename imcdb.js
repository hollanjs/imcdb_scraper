...
var request = require('request'),
	...
	fs = require('fs'),
	// Update the ID below to the movie you want.
	// See the readme for instructions on finding new movie IDs
	movieID = '415306'
	movieLink = 'http://imcdb.org/movie.php?resultsStyle=asImages&sortBy=4&id=' + movieID,
	movieTitle = null,
    carTitle = [],
	carSrc = [],
	carLinks = [],
